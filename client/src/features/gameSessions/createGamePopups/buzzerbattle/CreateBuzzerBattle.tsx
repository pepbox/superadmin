...
const CreateBuzzerBattle: React.FC<GameCreationComponentProps> = ({
    onClose,
    isSubmitting,
    handleCreateSession,
}) => {
        ...
        <div className="w-full max-w-lg mx-auto bg-white rounded-xl p-4 sm:p-8 px-3">
            <div className="flex justify-between items-center mb-6">
                <div className="text-center w-full">
                    <h2 className="text-2xl sm:text-3xl font-bold">Buzzer Battle</h2>
...
export default CreateBuzzerBattle;
